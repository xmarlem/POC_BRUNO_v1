    ...
    public static jobs = [
        {
            ...
            'allocationPerc': 100,
            'location' : 'Cabot Square, Canary Wharf, London, United Kingdom',
            'latitude' : 12.311949,
            'longitude': 76.658876,
        ...
        },
        {
            ...
            'title'    : 'Senior Software Engineer (SE) / Solution Architect (SA) in an Agile Team 80%',
        ...
        },
        {
            ...
            'title'    : 'Senior Project Manager for Strategy Implementation & Projects in International Wealth Management Compliance Division # 099076',
            'description'    : 'Switzerland-Region Zurich |   Full-time | Corporate Functions | Job ID 099076',
